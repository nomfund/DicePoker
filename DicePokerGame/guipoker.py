...
class GraphicsInterface:
    ...
    def __init__(self):
        self.win = GraphWin("Dice Game", 600, 400)
        self.win.setBackground("DarkSalmon")
        banner = Text(Point(300,30), "Dice Game")
        banner.setSize(24)
        banner.setFill("DarkRed")
        banner.setStyle("bold")
        banner.draw(self.win)
        self.msg = Text(Point(300,380), "Welcome")
        self.msg.setSize(18)
